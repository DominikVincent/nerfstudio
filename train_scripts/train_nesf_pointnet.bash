...
ns-train nesf --data /data/vision/polina/projects/wmh/dhollidt/datasets/klevr_nesf/0  \
	...
	--pipeline.datamanager.train-num-rays-per-batch 98304 \
	--pipeline.datamanager.eval-num-rays-per-batch 98304 \
	--pipeline.model.eval-num-rays-per-chunk 98304 \
	...
	--pipeline.model.feature-transformer-pointnet-config.radius_scale 0.3 \
	nesf-data \
