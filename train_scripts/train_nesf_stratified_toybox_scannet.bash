...
ns-train nesf --data /data/vision/polina/projects/wmh/dhollidt/datasets/klevr_nesf/0  \
	...
	--pipeline.model.feature-generator-config.jitter 0.0003 \
	--pipeline.model.feature-generator-config.jitter-clip 0.0012 \
	--pipeline.model.feature-generator-config.random_scale 0.8 \
	--pipeline.model.feature-generator-config.drop_feature_p 0.2 \
